              ...
              <div className='row'>
                <div className='col-lg-3 col-sm-6 m-b30'>
                  <div className='icon-bx-wraper style-3'>
                    ...
                    <div className='icon-content'>
                      <h5 className='title'>
                        <a href='service-detail.html'>Fresh Products</a>
                      </h5>
                      <p>
                ...
                <div className='col-lg-3 col-sm-6 m-b30'>
                  <div className='icon-bx-wraper style-3'>
                    ...
                    <div className='icon-content'>
                      <h5 className='title'>
                        <a href='service-detail.html'>Skilled Chefs</a>
                      </h5>
                      <p>
                        Lorem Ipsum is simply dummy text of the printing and{' '}
                      </p>
                ...
                <div className='col-lg-3 col-sm-6 m-b30'>
                  <div className='icon-bx-wraper style-3'>
                    ...
                    <div className='icon-content'>
                      <h5 className='title'>
                        <a href='service-detail.html'>Best Bar</a>
                      </h5>
                      <p>
                        Lorem Ipsum is simply dummy text of the printing and{' '}
                      </p>
                ...
                <div className='col-lg-3 col-sm-6 m-b30'>
                  <div className='icon-bx-wraper style-3'>
                    <div className='icon-bx'>
                      <div className='icon-cell'>
                        <i className='flaticon-cuisine' />
                      </div>
                    </div>
                    <div className='icon-content'>
                      <h5 className='title'>
                        <a href='service-detail.html'>Vegan Cuisine</a>
                      </h5>
                      <p>
                        Lorem Ipsum is simply dummy text of the printing and{' '}
                      </p>
                ...
                <div className='col-lg-3 col-sm-6 m-b30'>
                  <div className='icon-bx-wraper style-3'>
                    ...
                    <div className='icon-content'>
                      <h5 className='title'>
                        <a href='service-detail.html'>Free Supports</a>
                      </h5>
                      <p>
                        Lorem Ipsum is simply dummy text of the printing and{' '}
                      </p>
                ...
                <div className='col-lg-3 col-sm-6 m-b30'>
                  <div className='icon-bx-wraper style-3'>
                    ...
                    <div className='icon-content'>
                      <h5 className='title'>
                        <a href='service-detail.html'>Fast Serve On Table</a>
                      </h5>
                      <p>
                        Lorem Ipsum is simply dummy text of the printing and{' '}
                      </p>
                ...
                <div className='col-lg-3 col-sm-6 m-b30'>
                  <div className='icon-bx-wraper style-3'>
                    <div className='icon-bx'>
                      <div className='icon-cell'>
                        <i className='flaticon-pot' />
                      </div>
                    </div>
                    <div className='icon-content'>
                      <h5 className='title'>
                        <a href='service-detail.html'>Fresh Healthy Food</a>
                      </h5>
                      <p>
                        Lorem Ipsum is simply dummy text of the printing and{' '}
                      </p>
                ...
                <div className='col-lg-3 col-sm-6 m-b30'>
                  <div className='icon-bx-wraper style-3'>
                    ...
                    <div className='icon-content'>
                      <h5 className='title'>
                        <a href='service-detail.html'>Quick Delivery</a>
                      </h5>
                      <p>
                        Lorem Ipsum is simply dummy text of the printing and{' '}
                      </p>
                ...
                <div className='col-lg-3 col-sm-6 m-b30'>
                  <div className='icon-bx-wraper style-3'>
                    <div className='icon-bx'>
                      <div className='icon-cell'>
                        <i className='flaticon-token' />
                      </div>
                    </div>
                    <div className='icon-content'>
                      <h5 className='title'>
                        <a href='service-detail.html'>Order Tokan</a>
                      </h5>
                      <p>
                        Lorem Ipsum is simply dummy text of the printing and{' '}
                      </p>
                ...
                <div className='col-lg-3 col-sm-6 m-b30'>
                  <div className='icon-bx-wraper style-3'>
                    <div className='icon-bx'>
                      <div className='icon-cell'>
                        <i className='flaticon-furniture' />
                      </div>
                    </div>
                    <div className='icon-content'>
                      <h5 className='title'>
                        <a href='service-detail.html'>Table Service</a>
                      </h5>
                      <p>
                        Lorem Ipsum is simply dummy text of the printing and{' '}
                      </p>
                ...
                <div className='col-lg-3 col-sm-6 m-b30'>
                  <div className='icon-bx-wraper style-3'>
                    ...
                    <div className='icon-content'>
                      <h5 className='title'>
                        <a href='service-detail.html'>Awesome Team</a>
                      </h5>
                      <p>
                        Lorem Ipsum is simply dummy text of the printing and{' '}
                      </p>
                ...
                <div className='col-lg-3 col-sm-6 m-b30'>
                  <div className='icon-bx-wraper style-3'>
                    ...
                    <div className='icon-content'>
                      <h5 className='title'>
                        <a href='service-detail.html'>Discount Voucher</a>
                      </h5>
                      <p>
                        Lorem Ipsum is simply dummy text of the printing and{' '}
                      </p>
