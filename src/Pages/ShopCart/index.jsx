      ...
      <div>
        ...
        <div className='page-content bg-white'>
          ...
          <div
            ...
            style={{
              backgroundImage: 'url("assets/images/banner/bnr4.jpg")',
                    ...
                    <div className='dz-content'>
                      ...
                      <div className='dz-body'>
                        <ul className='dz-meta'>
                          ...
                          <li>
                            <i className='flaticon-scooter' /> 30 min
                          </li>
                        </ul>
                        <p className='mb-0'>
                          <span className='text-primary font-weight-500'>
                    ...
                    <div className='dz-content'>
                      ...
                      <div className='dz-body'>
                        <ul className='dz-meta'>
                          ...
                          <li>
                            <i className='flaticon-scooter' /> 45 min
                          </li>
                        </ul>
                        <p className='mb-0'>
                          <span className='text-primary font-weight-500'>
                    ...
                    <div className='dz-content'>
                      ...
                      <div className='dz-body'>
                        <ul className='dz-meta'>
                          ...
                          <li>
                            <i className='flaticon-scooter' /> 20 min
                          </li>
                        </ul>
                        <p className='mb-0'>
                          <span className='text-primary font-weight-500'>
                    ...
                    <div className='dz-content'>
                      ...
                      <div className='dz-body'>
                        <ul className='dz-meta'>
                          ...
                          <li>
                            <i className='flaticon-scooter' /> 40 min
                          </li>
                        </ul>
                        <p className='mb-0'>
                          <span className='text-primary font-weight-500'>
                    ...
                    <div className='dz-content'>
                      ...
                      <div className='dz-body'>
                        <ul className='dz-meta'>
                          ...
                          <li>
                            <i className='flaticon-scooter' /> 25 min
                          </li>
                        </ul>
                        <p className='mb-0'>
                          <span className='text-primary font-weight-500'>
                    ...
                    <div className='dz-content'>
                      ...
                      <div className='dz-body'>
                        <ul className='dz-meta'>
                          ...
                          <li>
                            <i className='flaticon-scooter' /> 60 min
                          </li>
                        </ul>
                        <p className='mb-0'>
                          <span className='text-primary font-weight-500'>
                  ...
                  <aside className='side-bar sticky-top'>
                    <div className='shop-filter style-1'>
                      ...
                      <div className='cart-item style-1'>
                        ...
                        <div className='dz-content'>
                          <div className='dz-head'>
                            <h6 className='title mb-0'>Double Patty Burger</h6>
                      ...
                      <div className='cart-item style-1'>
                        ...
                        <div className='dz-content'>
                          <div className='dz-head'>
                            <h6 className='title mb-0'>All Combo</h6>
                            <a href='javascript:void(0);'>
                              <i className='fa-solid fa-xmark text-danger' />
                            </a>
                          </div>
