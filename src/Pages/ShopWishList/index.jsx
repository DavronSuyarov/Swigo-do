                    ...
                    <table className='table check-tbl table-responsive-md'>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td className='product-item-name'>Cheese Pizza</td>
                        ...
                        <tr>
                          ...
                          <td className='product-item-name'>Fried Rice</td>
                        ...
                        <tr>
                          ...
                          <td className='product-item-name'>Green Salad</td>
                          <td className='product-item-price'>$15.00</td>
                          <td className='product-item-totle'>
                            <a
                              href='shop-cart.html'
                              className='btn btn-gray btn-hover-2'
                        ...
                        <tr>
                          ...
                          <td className='product-item-name'>Butterfly Pasta</td>
                          <td className='product-item-price'>$55.00</td>
                          <td className='product-item-totle'>
                            <a
                              href='shop-cart.html'
                              className='btn btn-gray btn-hover-2'
