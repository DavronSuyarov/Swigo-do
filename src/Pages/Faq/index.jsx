            ...
            <div className='min-container'>
              ...
              <div className='row'>
                <div className='col-12'>
                  <div className='accordion dz-accordion' id='accordionFaq2'>
                    ...
                    <div className='accordion-item'>
                      <h2 className='accordion-header' id='headingSix1'>
                        <a
                          href='#'
                          className='accordion-button collapsed'
                          data-bs-toggle='collapse'
                    ...
                    <div className='accordion-item'>
                      <h2 className='accordion-header' id='headingSeven1'>
                        <a
                          href='#'
                          className='accordion-button collapsed'
                          data-bs-toggle='collapse'
                ...
                <div className='col-lg-7 m-b20'>
                  <div className='faq-info'>
                    ...
                    <p className='m-b30'>
                      ...
                      announce some new additions to our menu that we think
                      you'll love. Our culinary team has been
                    </p>
                    <form
