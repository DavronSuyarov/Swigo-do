                      ...
                      <ul className='dish-gallery gallery-grid-2'>
                        <li>
                          <a href='product-detail.html'>
                            <div className='gallery-box-1'>
                              <img
                                src='assets/images/gallery/grid5/pic1.jpg'
                                alt='/'
                              />
                              <span className='category'>Sweet Cake</span>
                            </div>
                          </a>
                        </li>
                        <li>
                          <a href='product-detail.html'>
                            <div className='gallery-box-1'>
                              <img
                                src='assets/images/gallery/grid5/pic5.jpg'
                                alt='/'
                              />
                        ...
                        <li>
                          <a href='product-detail.html'>
                            <div className='gallery-box-1'>
                              <img
                                src='assets/images/gallery/grid5/pic7.jpg'
                                alt='/'
                              />
                        ...
                        <li>
                          <a href='product-detail.html'>
                            <div className='gallery-box-1'>
                              <img
                                src='assets/images/gallery/grid5/pic4.jpg'
                                alt='/'
                              />
                      ...
                      <div className='team-skills'>
                        ...
                        <div className='progress-bx style-1'>
                          <h6 className='progress-label'>
                            Skills
                            <span className='pull-end'>60%</span>
                          </h6>
                        ...
                        <div className='progress-bx style-1'>
                          <h6 className='progress-label'>
                            Customer Satisfied
                            <span className='pull-end'>95%</span>
                          </h6>
                          <div className='progress primary rounded-md m-b20'>
                            <div
                              className='progress-bar rounded-md'
                        ...
                        <div className='progress-bx style-1'>
                          <h6 className='progress-label'>
                            ...
                            <span className='pull-end'>75%</span>
                          </h6>
                          <div className='progress primary rounded-md m-b20'>
                            <div
                              className='progress-bar rounded-md'
