            ...
            <div className='container'>
              <div className='row'>
                ...
                <div className='col-lg-3 col-sm-6 m-b30'>
                  <div className='dz-team style-1'>
                    ...
                    <div className='dz-content'>
                      <div className='clearfix'>
                        <h6 className='dz-name'>
                          <a href='team-detail.html'>Raiyan Kovin</a>
                        </h6>
                        <span className='dz-position'>Senior Chef</span>
                      </div>
                      <ul className='team-social'>
                ...
                <div className='col-lg-3 col-sm-6 m-b30'>
                  <div className='dz-team style-1'>
                    ...
                    <div className='dz-content'>
                      <div className='clearfix'>
                        <h6 className='dz-name'>
                          <a href='team-detail.html'>Stevin Mark</a>
                        </h6>
                        <span className='dz-position'>Senior Chef</span>
                      </div>
                      <ul className='team-social'>
                ...
                <div className='col-lg-3 col-sm-6 m-b30'>
                  <div className='dz-team style-1'>
                    <div className='dz-media'>
                      <img src='assets/images/team/pic7.jpg' alt='/' />
                    </div>
                    <div className='dz-content'>
                      <div>
                ...
                <div className='col-lg-3 col-sm-6 m-b30'>
                  <div className='dz-team style-1'>
                    <div className='dz-media'>
                      <img src='assets/images/team/pic8.jpg' alt='/' />
                    </div>
                    <div className='dz-content'>
                      <div>
                        <h5 className='dz-name'>
                ...
                <div className='col-lg-3 col-sm-6 m-b30'>
                  <div className='dz-team style-1'>
                    <div className='dz-media'>
                      <img src='assets/images/team/pic9.jpg' alt='/' />
                    </div>
                    <div className='dz-content'>
                      <div>
                        <h5 className='dz-name'>
                ...
                <div className='col-lg-3 col-sm-6 m-b30'>
                  <div className='dz-team style-1'>
                    <div className='dz-media'>
                      <img src='assets/images/team/pic12.jpg' alt='/' />
                    </div>
                    <div className='dz-content'>
                      <div>
                        <h5 className='dz-name'>
                          <a href='team-detail.html'>Martin Doe</a>
                        </h5>
                        <span className='dz-position'>Senior Chef</span>
                      </div>
                      <ul className='team-social'>
                ...
                <div className='col-lg-3 col-sm-6 m-b30'>
                  <div className='dz-team style-1'>
                    <div className='dz-media'>
                      <img src='assets/images/team/pic10.jpg' alt='/' />
                    </div>
                    <div className='dz-content'>
                      <div>
                        <h5 className='dz-name'>
