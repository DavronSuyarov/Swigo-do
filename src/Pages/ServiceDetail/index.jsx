                    ...
                    <div className='widget recent-posts-entry'>
                      ...
                      <div className='widget-post-bx style-1'>
                        <div className='widget-post clearfix'>
                          <div className='dz-media'>
                            <img
                              src='assets/images/blog/recent-blog/pic4.jpg'
                              alt='/'
                            />
                          </div>
                          <div className='dz-info'>
                            <div className='dz-meta'>
                              <ul>
                                ...
                                <li className='date'>
                                  <a href='javascript:void(0);'>Dec 10, 2023</a>
                                </li>
                              </ul>
                            </div>
                            <h6 className='title'>
                      ...
                      <div className='widget-post-bx style-1'>
                        <div className='widget-post clearfix'>
                          <div className='dz-media'>
                            <img
                              src='assets/images/blog/recent-blog/pic5.jpg'
                              alt='/'
                            />
                          </div>
                          <div className='dz-info'>
                            <div className='dz-meta'>
                              <ul>
                                ...
                                <li className='date'>
                                  <a href='javascript:void(0);'>May 12, 2023</a>
                                </li>
                              </ul>
                            </div>
                            <h6 className='title'>
                    ...
                    <div className='widget widget_categories'>
                      ...
                      <ul>
                        <li className='cat-item'>
                          <a href='blog-standard.html'>All Services</a>
                        </li>
                        <li className='cat-item'>
                          <a href='blog-standard.html'>Water</a>
                        </li>
                        <li className='cat-item'>
                          <a href='blog-standard.html'>Residental Cleaning</a>
                        </li>
                        <li className='cat-item'>
                          <a href='blog-standard.html'>Summer Pizza</a>
                        </li>
                        <li className='cat-item'>
                          <a href='blog-standard.html'>Free Support</a>
                        </li>
                      </ul>
                    </div>
                  </aside>
                ...
                <div className='col-lg-8 order-lg-2 order-1 m-b30'>
                  <div className='blog-single dz-card sidebar mb-0'>
                    <div className='dz-media rounded-md'>
                      <img src='assets/images/blog/detail/pic2.jpg' alt='/' />
                    </div>
                    <div className='dz-info'>
                      <h2 className='title'>
